...
const main = () => {
  const feed = new RSS({
    title: 'Sintu Boro',
    site_url: 'https://sboro.vercel.app',
    feed_url: 'https://sboro.vercel.app/feed.xml',
    image_url: 'https://sboro.vercel.app/og.png',
    language: 'en'
  })

  posts.forEach(post => {
    const url = `https://sboro.vercel.app/blog/${post.slug}`

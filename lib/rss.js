...
const main = () => {
  const feed = new RSS({
    title: 'Sintu Boro',
    site_url: 'https://sdotboro.vercel.app',
    feed_url: 'https://sdotboro.vercel.app/feed.xml',
    image_url: 'https://sdotboro.vercel.app/og.png',
    language: 'en'
  })

  posts.forEach(post => {
    const url = `https://sdotboro.vercel.app/blog/${post.slug}`
